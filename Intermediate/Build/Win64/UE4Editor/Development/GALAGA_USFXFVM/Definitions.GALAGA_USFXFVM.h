...
#define UE_PROJECT_NAME GALAGA_USFXFVM
#define UE_TARGET_NAME GALAGA_USFXFVMEditor
#define UE_MODULE_NAME "GALAGA_USFXFVM"
...
#define GALAGA_USFXFVM_API DLLEXPORT
